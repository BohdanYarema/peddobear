        ...
        <div class="header-inner">
            <div class="header-nav-wrap">
                <ul class="header-nav">
                    ...
                    <li class="header-nav__item"><a class="header-nav__link" data-menu="gallery-page"   href="#"> <span>Gallery</span></a></li>
                    <li class="header-nav__item"><a class="header-nav__link" data-menu="special-page"   href="#"> <span>Special offers</span></a></li>
                    <li class="header-nav__item"><a class="header-nav__link" data-menu="cart-page"      href="<?=Url::to('/cart')?>"> <span>Shoping Cart</span><!--</a></li>
                <li class="header-nav__item"><a class="header-nav__link" href="#"> <span>Contacts--></span></a></li>
                </ul>
                <div class="total-cart"><a class="cart-button" href="#">
                        <div class="total-cart__cart"><img src="img/cart.png"></div>
                        <div class="total-cart__total">
                            <div class="total-price"><span class="cart-amount">100</span></div>
                            <div class="total-price"><img src="img/dollar.png"></div>
                        </div></a></div>
